...
public final class EditBookOffersScreen extends Screen
{
	...
	public void init()
	{
		...
		addDrawableChild(new ButtonWidget(width / 2 - 154, height - 56, 100, 20,
			Text.literal("Add"),
			b -> client.setScreen(new AddBookOfferScreen(this, bookOffers))));
		
		addDrawableChild(editButton = new ButtonWidget(width / 2 - 50,
			height - 56, 100, 20, Text.literal("Edit"), b -> {
		...
		addDrawableChild(removeButton = new ButtonWidget(width / 2 + 54,
			height - 56, 100, 20, Text.literal("Remove"),
			b -> bookOffers.remove(listGui.selected)));
		removeButton.active = false;
		
		addDrawableChild(new ButtonWidget(width - 106, 6, 100, 20,
		...
		addDrawableChild(
			doneButton = new ButtonWidget(width / 2 - 100, height - 32, 200, 20,

...
public abstract class ListWidget extends FocusableGui
	implements IRenderable
{
	...
	public ListWidget(Minecraft client, int width, int height, int top,
		...
		float delta)
	{
		if(visible)
		{
			...
			bufferBuilder.pos(left, bottom, 0.0D)
				.tex(left / 32.0F, (bottom + (int)scrollAmount) / 32.0F)
				.color(32, 32, 32, 255).endVertex();
			bufferBuilder.pos(right, bottom, 0.0D)
				.tex(right / 32.0F, (bottom + (int)scrollAmount) / 32.0F)
				.color(32, 32, 32, 255).endVertex();
			bufferBuilder.pos(right, top, 0.0D)
				.tex(right / 32.0F, (top + (int)scrollAmount) / 32.0F)
				.color(32, 32, 32, 255).endVertex();
			bufferBuilder.pos(left, top, 0.0D)
				.tex(left / 32.0F, (top + (int)scrollAmount) / 32.0F)
				.color(32, 32, 32, 255).endVertex();
			tessellator.draw();
			...
			bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			bufferBuilder.pos(left, top + 4, 0.0D).tex(0.0F, 1.0F)
				.color(0, 0, 0, 0).endVertex();
			bufferBuilder.pos(right, top + 4, 0.0D).tex(1.0F, 1.0F)
				.color(0, 0, 0, 0).endVertex();
			bufferBuilder.pos(right, top, 0.0D).tex(1.0F, 0.0F)
				.color(0, 0, 0, 255).endVertex();
			bufferBuilder.pos(left, top, 0.0D).tex(0.0F, 0.0F)
				.color(0, 0, 0, 255).endVertex();
			tessellator.draw();
			bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			bufferBuilder.pos(left, bottom, 0.0D).tex(0.0F, 1.0F)
				.color(0, 0, 0, 255).endVertex();
			bufferBuilder.pos(right, bottom, 0.0D).tex(1.0F, 1.0F)
				.color(0, 0, 0, 255).endVertex();
			bufferBuilder.pos(right, bottom - 4, 0.0D).tex(1.0F, 0.0F)
				.color(0, 0, 0, 0).endVertex();
			bufferBuilder.pos(left, bottom - 4, 0.0D).tex(0.0F, 0.0F)
				.color(0, 0, 0, 0).endVertex();
			tessellator.draw();
			int n = getMaxScroll();
			if(n > 0)
			{
				...
				bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				bufferBuilder.pos(i, bottom, 0.0D).tex(0.0F, 1.0F)
					.color(0, 0, 0, 255).endVertex();
				bufferBuilder.pos(j, bottom, 0.0D).tex(1.0F, 1.0F)
					.color(0, 0, 0, 255).endVertex();
				bufferBuilder.pos(j, top, 0.0D).tex(1.0F, 0.0F)
					.color(0, 0, 0, 255).endVertex();
				bufferBuilder.pos(i, top, 0.0D).tex(0.0F, 0.0F)
					.color(0, 0, 0, 255).endVertex();
				tessellator.draw();
				bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				bufferBuilder.pos(i, p + o, 0.0D).tex(0.0F, 1.0F)
					.color(128, 128, 128, 255).endVertex();
				bufferBuilder.pos(j, p + o, 0.0D).tex(1.0F, 1.0F)
					.color(128, 128, 128, 255).endVertex();
				bufferBuilder.pos(j, p, 0.0D).tex(1.0F, 0.0F)
					.color(128, 128, 128, 255).endVertex();
				bufferBuilder.pos(i, p, 0.0D).tex(0.0F, 0.0F)
					.color(128, 128, 128, 255).endVertex();
				tessellator.draw();
				bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
				bufferBuilder.pos(i, p + o - 1, 0.0D).tex(0.0F, 1.0F)
					.color(192, 192, 192, 255).endVertex();
				bufferBuilder.pos(j - 1, p + o - 1, 0.0D).tex(1.0F, 1.0F)
					.color(192, 192, 192, 255).endVertex();
				bufferBuilder.pos(j - 1, p, 0.0D).tex(1.0F, 0.0F)
					.color(192, 192, 192, 255).endVertex();
				bufferBuilder.pos(i, p, 0.0D).tex(0.0F, 0.0F)
					.color(192, 192, 192, 255).endVertex();
				tessellator.draw();
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button)
	{
		...
		if(isVisible() && isMouseInList(mouseX, mouseY))
		{
			...
			{
				if(getEventListeners().size() > i)
					setListener(getEventListeners().get(i));
	...
	{
		if(getListener() != null)
			getListener().mouseReleased(mouseX, mouseY, button);
		...
		int l, float f)
	{
		...
		for(int n = 0; n < m; ++n)
		{
			...
			if(renderSelection && isSelectedItem(n))
			{
				...
				bufferBuilder.pos(q, o + p + 2, 0.0D).endVertex();
				bufferBuilder.pos(r, o + p + 2, 0.0D).endVertex();
				bufferBuilder.pos(r, o - 2, 0.0D).endVertex();
				bufferBuilder.pos(q, o - 2, 0.0D).endVertex();
				tessellator.draw();
				RenderSystem.color4f(0.0F, 0.0F, 0.0F, 1.0F);
				bufferBuilder.begin(7, DefaultVertexFormats.POSITION);
				bufferBuilder.pos(q + 1, o + p + 1, 0.0D).endVertex();
				bufferBuilder.pos(r - 1, o + p + 1, 0.0D).endVertex();
				bufferBuilder.pos(r - 1, o - 1, 0.0D).endVertex();
				bufferBuilder.pos(q + 1, o - 1, 0.0D).endVertex();
				tessellator.draw();
				RenderSystem.enableTexture();
			}
		...
		int bottomAlpha)
	{
		...
		RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
		bufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		bufferBuilder.pos(left, bottom, 0.0D).tex(0.0F, bottom / 32.0F)
			.color(64, 64, 64, bottomAlpha).endVertex();
		bufferBuilder.pos(left + width, bottom, 0.0D)
			.tex(width / 32.0F, bottom / 32.0F)
			.color(64, 64, 64, bottomAlpha).endVertex();
		bufferBuilder.pos(left + width, top, 0.0D)
			.tex(width / 32.0F, top / 32.0F).color(64, 64, 64, topAlpha)
			.endVertex();
		bufferBuilder.pos(left, top, 0.0D).tex(0.0F, top / 32.0F)
			.color(64, 64, 64, topAlpha).endVertex();
		tessellator.draw();
	}
}

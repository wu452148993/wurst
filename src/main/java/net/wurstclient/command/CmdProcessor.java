...
import net.minecraft.crash.CrashReportCategory;//CrashReportSection;
...
public final class CmdProcessor implements ChatOutputListener
{
	...
	private void runCmd(Command cmd, String input)
	{
		...
		{
			CrashReport report = CrashReport.makeCrashReport(e, "Running Wurst command");
			CrashReportCategory section = report.makeCategory("Affected command");
			section.addDetail("Command input", () -> input);
